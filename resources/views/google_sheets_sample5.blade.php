...
<?php
  ...
  $values = [
    ["=ROUND((ROUND((ROUND(10*RAND())+10)*RAND()*10))/(10+(ROUND(10*RAND())+5)),1)","=ROUND((ROUND((ROUND(10*RAND())+10)*RAND()*10))/(10+(ROUND(10*RAND())+5)),1)", "=ROUND((ROUND((ROUND(10*RAND())+10)*RAND()*10))/(10+(ROUND(10*RAND())+5)),1)", "=ROUND((ROUND((ROUND(10*RAND())+10)*RAND()*10))/(10+(ROUND(10*RAND())+5)),1)", "=ROUND((ROUND((ROUND(10*RAND())+10)*RAND()*10))/(10+(ROUND(10*RAND())+5)),1)", "=ROUND((ROUND((ROUND(10*RAND())+10)*RAND()*10))/(10+(ROUND(10*RAND())+5)),1)", "=ROUND((ROUND((ROUND(10*RAND())+10)*RAND()*10))/(10+(ROUND(10*RAND())+5)),1)", "=ROUND((ROUND((ROUND(10*RAND())+10)*RAND()*10))/(10+(ROUND(10*RAND())+5)),1)", "=ROUND((ROUND((ROUND(10*RAND())+10)*RAND()*10))/(10+(ROUND(10*RAND())+5)),1)", "=ROUND((ROUND((ROUND(10*RAND())+10)*RAND()*10))/(10+(ROUND(10*RAND())+5)),1)", "", "max"],
    ["=ROUND((ROUND((ROUND(10*RAND())+10)*RAND()*10))/(10+(ROUND(10*RAND())+5)),1)","=ROUND((ROUND((ROUND(10*RAND())+10)*RAND()*10))/(10+(ROUND(10*RAND())+5)),1)", "=ROUND((ROUND((ROUND(10*RAND())+10)*RAND()*10))/(10+(ROUND(10*RAND())+5)),1)", "=ROUND((ROUND((ROUND(10*RAND())+10)*RAND()*10))/(10+(ROUND(10*RAND())+5)),1)", "=ROUND((ROUND((ROUND(10*RAND())+10)*RAND()*10))/(10+(ROUND(10*RAND())+5)),1)", "=ROUND((ROUND((ROUND(10*RAND())+10)*RAND()*10))/(10+(ROUND(10*RAND())+5)),1)", "=ROUND((ROUND((ROUND(10*RAND())+10)*RAND()*10))/(10+(ROUND(10*RAND())+5)),1)", "=ROUND((ROUND((ROUND(10*RAND())+10)*RAND()*10))/(10+(ROUND(10*RAND())+5)),1)", "=ROUND((ROUND((ROUND(10*RAND())+10)*RAND()*10))/(10+(ROUND(10*RAND())+5)),1)", "=ROUND((ROUND((ROUND(10*RAND())+10)*RAND()*10))/(10+(ROUND(10*RAND())+5)),1)", "", "min"],
    ["=ROUND((ROUND((ROUND(10*RAND())+10)*RAND()*10))/(10+(ROUND(10*RAND())+5)),1)","=ROUND((ROUND((ROUND(10*RAND())+10)*RAND()*10))/(10+(ROUND(10*RAND())+5)),1)", "=ROUND((ROUND((ROUND(10*RAND())+10)*RAND()*10))/(10+(ROUND(10*RAND())+5)),1)", "=ROUND((ROUND((ROUND(10*RAND())+10)*RAND()*10))/(10+(ROUND(10*RAND())+5)),1)", "=ROUND((ROUND((ROUND(10*RAND())+10)*RAND()*10))/(10+(ROUND(10*RAND())+5)),1)", "=ROUND((ROUND((ROUND(10*RAND())+10)*RAND()*10))/(10+(ROUND(10*RAND())+5)),1)", "=ROUND((ROUND((ROUND(10*RAND())+10)*RAND()*10))/(10+(ROUND(10*RAND())+5)),1)", "=ROUND((ROUND((ROUND(10*RAND())+10)*RAND()*10))/(10+(ROUND(10*RAND())+5)),1)", "=ROUND((ROUND((ROUND(10*RAND())+10)*RAND()*10))/(10+(ROUND(10*RAND())+5)),1)", "=ROUND((ROUND((ROUND(10*RAND())+10)*RAND()*10))/(10+(ROUND(10*RAND())+5)),1)", "", "avg"],
    ["=ROUND((ROUND((ROUND(10*RAND())+10)*RAND()*10))/(10+(ROUND(10*RAND())+5)),1)","=ROUND((ROUND((ROUND(10*RAND())+10)*RAND()*10))/(10+(ROUND(10*RAND())+5)),1)", "=ROUND((ROUND((ROUND(10*RAND())+10)*RAND()*10))/(10+(ROUND(10*RAND())+5)),1)", "=ROUND((ROUND((ROUND(10*RAND())+10)*RAND()*10))/(10+(ROUND(10*RAND())+5)),1)", "=ROUND((ROUND((ROUND(10*RAND())+10)*RAND()*10))/(10+(ROUND(10*RAND())+5)),1)", "=ROUND((ROUND((ROUND(10*RAND())+10)*RAND()*10))/(10+(ROUND(10*RAND())+5)),1)", "=ROUND((ROUND((ROUND(10*RAND())+10)*RAND()*10))/(10+(ROUND(10*RAND())+5)),1)", "=ROUND((ROUND((ROUND(10*RAND())+10)*RAND()*10))/(10+(ROUND(10*RAND())+5)),1)", "=ROUND((ROUND((ROUND(10*RAND())+10)*RAND()*10))/(10+(ROUND(10*RAND())+5)),1)", "=ROUND((ROUND((ROUND(10*RAND())+10)*RAND()*10))/(10+(ROUND(10*RAND())+5)),1)"],
    ["=ROUND((ROUND((ROUND(10*RAND())+10)*RAND()*10))/(10+(ROUND(10*RAND())+5)),1)","=ROUND((ROUND((ROUND(10*RAND())+10)*RAND()*10))/(10+(ROUND(10*RAND())+5)),1)", "=ROUND((ROUND((ROUND(10*RAND())+10)*RAND()*10))/(10+(ROUND(10*RAND())+5)),1)", "=ROUND((ROUND((ROUND(10*RAND())+10)*RAND()*10))/(10+(ROUND(10*RAND())+5)),1)", "=ROUND((ROUND((ROUND(10*RAND())+10)*RAND()*10))/(10+(ROUND(10*RAND())+5)),1)", "=ROUND((ROUND((ROUND(10*RAND())+10)*RAND()*10))/(10+(ROUND(10*RAND())+5)),1)", "=ROUND((ROUND((ROUND(10*RAND())+10)*RAND()*10))/(10+(ROUND(10*RAND())+5)),1)", "=ROUND((ROUND((ROUND(10*RAND())+10)*RAND()*10))/(10+(ROUND(10*RAND())+5)),1)", "=ROUND((ROUND((ROUND(10*RAND())+10)*RAND()*10))/(10+(ROUND(10*RAND())+5)),1)", "=ROUND((ROUND((ROUND(10*RAND())+10)*RAND()*10))/(10+(ROUND(10*RAND())+5)),1)"],
  ...
  $params = [
    ...
    ['function' => 'setValues', 'parameters'=> (object)['valueRange' => 'A1:L10', 'values' => $values]],
    //['function' => 'getValues', 'parameters'=> (object)['valueRange' => 'A1:L10']],
    ...
    ['function' => 'setHorizontalAlignment', 'parameters'=> (object)['alignment'=>"LEFT", "range"=>"A1:J10",'sheetId'=>0]],
     ['function' => 'setHorizontalAlignment', 'parameters'=> (object)['alignment'=>"LEFT", "range"=>"L1:L3",'sheetId'=>0]]
