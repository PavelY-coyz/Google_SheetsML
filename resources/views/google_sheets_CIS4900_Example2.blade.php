...
<?php
  ...
  $params = [
    ...
    ['function' => 'setBackgroundColor', 'parameters'=> (object)['range' => 'A1:G1', 'color' => 'r=255,g=255,b=255', 'sheetId'=>0]],
    ['function' => 'disableCells', 'parameters'=> (object)['range' => "A1:J10", 'email'=>'testmail@test.com', 'sheetId'=>0]],
    ['function' => 'disableCells', 'parameters'=> (object)['range' => "L1:M4", 'email'=>'testmail@test.com', 'sheetId'=>0]],
    ...
    ['function' => 'setCellFormat', 'parameters'=> (object)['range'=>"L1:L4", "type"=>"TEXT", "optParams"=>["pattern"=>""]]],
    ['function' => 'setCellFormat', 'parameters'=> (object)['range'=>"M1:M4", "type"=>"NUMBER", "optParams"=>["pattern"=>""]]],
  ];
/*  //$params = [];
