...
<?php
  ...
  // $A = "=ROUND(10*RAND()+10)";
  // $B = "=ROUND(10*RAND()+5)";
  // $dataInput = "=ROUND((A*RAND()*10)/10 + B)"
  //translated into function 
  //"=ROUND((ROUND(10*RAND()+10))*RAND()*10)/10 + (ROUND(10*RAND()+5))"
  $values = [
    ["=ROUND((ROUND(10*RAND()+10))*RAND()*10)/10 + (ROUND(10*RAND()+5))", "=ROUND((ROUND(10*RAND()+10))*RAND()*10)/10 + (ROUND(10*RAND()+5))",
      "=ROUND((ROUND(10*RAND()+10))*RAND()*10)/10 + (ROUND(10*RAND()+5))", "=ROUND((ROUND(10*RAND()+10))*RAND()*10)/10 + (ROUND(10*RAND()+5))",
      "=ROUND((ROUND(10*RAND()+10))*RAND()*10)/10 + (ROUND(10*RAND()+5))", "=ROUND((ROUND(10*RAND()+10))*RAND()*10)/10 + (ROUND(10*RAND()+5))",
      "=ROUND((ROUND(10*RAND()+10))*RAND()*10)/10 + (ROUND(10*RAND()+5))", "=ROUND((ROUND(10*RAND()+10))*RAND()*10)/10 + (ROUND(10*RAND()+5))",
      "=ROUND((ROUND(10*RAND()+10))*RAND()*10)/10 + (ROUND(10*RAND()+5))", "=ROUND((ROUND(10*RAND()+10))*RAND()*10)/10 + (ROUND(10*RAND()+5))",
